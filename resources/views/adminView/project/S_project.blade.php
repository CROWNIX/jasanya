                                                ...
                                                @forelse ($project as $x)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="modal fade" id="addRowModal{{ $x->id }}"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div
                                                                                            ...
                                                                                            <textarea class="form-control" name="keterangan" id="exampleTextarea1" rows="1">{{ $x->keterangan }}</textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    @if ($x->pekerja != 'null')
                                                                                    ...
                                                                                    @else
                                                                                        <div class="col-sm-12">
                                                                                            <div
                                                                                                class="form-group form-group-default">
                                                                                                <label
                                                                                                    for="time_completed">Pekerja</label>
