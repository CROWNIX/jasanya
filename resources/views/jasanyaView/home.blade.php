...
@section('container')
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container px-lg-5"id="home">
                    <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">Jasa <span
                                    class="auto-type text-warning"></span></h1>
        ...
        <!-- Projects Start -->
        <div class="container-xxl" id="project">
            <div class="container py-5 px-lg-5">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
        ...
        <!-- Testimonial Start --><br><br><br><br>
        <div class="container-xxl wow fadeInUp" data-wow-delay="0.1s" id="testimoni">
            <div class="container py-5 px-lg-5">
        ...
        <!-- Team Start -->
        <div class="container-xxl" id="team">
            <div class="container py-5 px-lg-5">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
